...
import { Menu, X, Sun, Moon, Phone, ChevronDown, Cross } from "lucide-react";
    ...
    >
      <div className="hidden lg:flex items-center justify-between px-8 py-1.5 bg-brand-600 dark:bg-brand-800 text-white text-xs">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1.5"><Phone size={11} />+250 780 000 000</span>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {lang === "en" ? "RW" : "EN"}<ChevronDown size={11} />
          </button>
